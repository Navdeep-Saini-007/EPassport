...
namespace EPassport.Controllers
{
    public class UserInformationController : Controller
    {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("ApplicantId,FirstName,LastName,Dob,PlaceOfBirth,Gender,State,District,MaritalStatus,Pan,EmploymentType,EducationalQualification,LoginId")] ApplicationDetail applicationDetail)
        //{
